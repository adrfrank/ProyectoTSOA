...
public class Nucleo{
    ...
    public static void InsertarTE(int dameID, ParMaquinaProceso asa) {
        
            nucleo.TablaEmision.put(asa.dameID(), asa);
    
    }
    
    public static void InsertarLocales(Locales serLocal) {
            nucleo.registroServidor(serLocal);
    }
