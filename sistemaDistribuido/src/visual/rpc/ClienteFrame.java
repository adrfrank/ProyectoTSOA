...
public class ClienteFrame extends ProcesoFrame{
	...
	public Panel construirPanelSolicitud(){
		...
		pcodop1.add(new Label("Ordena >> "));
		pcodop1.add(new Label("Param n:"));
		pcodop1.add(campo1);

		pcodop2.add(new Label("Cuadrado >> "));
		pcodop2.add(new Label("Param 1:"));
		pcodop2.add(campo2);

		pcodop3.add(new Label("Promedio >> "));
		pcodop3.add(new Label("Param n:"));
		pcodop3.add(campo3);
	...
	class ManejadorSolicitud implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if (com.equals("Solicitar")){
				...
				proc.pasameDatos(campo1.getText(), campo2.getText(), campo3.getText(),campo4.getText());
